...
.CELL, 1.celda (ancho, alto, texto, bordes,2.Posicion inicial ,3.alineacion(C)centrado,(L)(R),
4.relleno (con color), (true)
$pdf->setfilecolor(55,89,78)
links
.WRITE, alinea de texto- sin importancia del ordena miento
*/

/*
$pdf->SetFont('Arial','B',9);
Tenemos disponibles 5 TIPOS:
COURIER,DELVETICA,ARIAL,TIMES,SYMBOL,ZAPDINGEATS
ESTILO: normal,B(NEGRITA),I(CURSIVA),U
TAMAÑO:defecto 12......
*/

/*
$pdf->AliasNbPages();//NUMERACION DE PAGINA
//1RO ORIENTACION de  nuestro UESTRO ARCHIVO, MODO RETRATO O PANORAMICO
//2DO TAMAÑO que va atener nuestra pagina (a3,a4,a5,letter, legal)
//3RO ROTACION
*/
...
salida al navegador
$pdf->Output();
'I' defecto, se muestra en el navegador
'D' descarga el archivo 
'f' guarda el archivo dentro del servidor
'S' devuelve al archo pdf como cadena
2- resive el nombre del archivo
3. si esta en utf8
*/

/*
x, y ,alto, ancho, tipo, enlases
$this->Image('img/logo.png',55,3,20,20,'png','https://www.youtube.com/watch?v=vsoSeBHqLSQ');

*/

/*
color de texto
$this->SetTextColor(100,240,120);
*/
