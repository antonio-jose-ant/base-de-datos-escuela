<?php
        ...
        $datosMedicosA = $_SESSION['datosMedicosA'];
        $tutor1A = $_SESSION['tutor1A'];
        $tutor2A = $_SESSION['tutor2A'];
        $DomicilioA = $_SESSION['DomicilioA'];
        $datosGeneralesA = $_SESSION['datosGeneralesA'];*/
